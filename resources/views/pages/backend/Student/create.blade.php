...
<div class="col-md-12 col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{route('student.store')}}"  class="form form-horizontal" enctype="multipart/form-data">
            @csrf
          ...
          <div class="row">
            ...
            <div class="col-sm-9 offset-sm-3">
              <button type="submit" class="btn btn-primary me-1 waves-effect waves-float waves-light">Add Student</button>
          </div>
        </div>
    </div>
        </form>
